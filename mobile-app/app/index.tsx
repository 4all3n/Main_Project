...
import { ActivityIndicator, Card, Surface, Text, useTheme } from 'react-native-paper';
...
export default function Dashboard() {
  ...
  // UI Components
  const MetricCard = ({ title, value, unit, icon, color, subValue, fullWidth = false }: any) => (
    <Card 
        mode="contained" 
        style={[styles.card, fullWidth && styles.fullWidthCard, { backgroundColor: theme.colors.surfaceVariant }]}
    >
